# Calculator
This repository contains Task 2 of my LetsGrowMore internship as a web developer. The task is related to a Calculator project, which I have implemented as part of my internship program. In this project, I've created a web-based Calculator application that allows users to Calculations.
